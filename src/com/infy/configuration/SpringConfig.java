...
public class SpringConfig {
	...
	public DataSource dataSource() {
		...
		//change the URL based on the database you use
		dataSource.setUrl("jdbc:oracle:thin:@10.123.79.59:1521:georli04");
		//change your  credentials below if it is different
		dataSource.setUsername("T562894");
		dataSource.setPassword("T562894");
		return dataSource;
	}
